...
const DataRow = (props) => {
  ...
  return (
    <div className="min-w-[700px] md:min-w-full cursor-pointer" onClick={() => { !props.header && !props.threeDots && navigate("/teacher/attendence/submission", { state: props?.allData }) }}>
      ...
      >
        <div className="flex flex-row items-center flex-1 px-2 py-[4px] mt-1 md:pl-3 md:pr-5 space-x-5 " onClick={() => { !props.header && navigate("/teacher/attendence/submission", { state: props?.allData }) }}>
          <p
