...
const Card = ({ data, type, grade, percentage }) => {
    const config = CARD_CONFIG[data] || CARD_CONFIG["Quizes"];
    ...
    return (
        <div
            className="flex-1 min-w-[200px] relative overflow-hidden rounded-[20px] border border-[#00000015] 
                 bg-white flex flex-col items-center gap-3 pt-6 pb-5 px-4 shadow-sm
        ...
        >
            ...
            {/* Title */}
            <p className="text-[13px] font-semibold text-center text-gray-800">
                {data}
            </p>
        </div>
    );
