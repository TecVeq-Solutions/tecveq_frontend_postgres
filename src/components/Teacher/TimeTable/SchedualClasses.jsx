...
const SchedualClasses = ({ refetch, addScheduleModalOpen, setAddScheduleModalOpen }) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex justify-end items-start bg-slate-900/40 backdrop-blur-[2px] animate-in fade-in duration-300">
      <div className="mr-0 sm:mr-6 mt-20  w-[440px] bg-white rounded-0 sm:rounded-[24px] shadow-[0_20px_50px_rgba(8,_112,_184,_0.2)] flex flex-col max-h-[100vh] sm:max-h-[92vh] animate-in slide-in-from-right duration-500 overflow-hidden border  border-blue-50">
