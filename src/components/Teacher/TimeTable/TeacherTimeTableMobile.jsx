...
const TeacherTimeTableMobile = ({ data, isPending, refetch, isRefetching }) => {
    ...
    return (
        <div className="relative flex min-h-screen w-full min-w-[320px] flex-col overflow-x-hidden bg-gradient-to-br from-[#f0f4ff] via-[#eef4ff] to-[#f0f9ff] pb-10 font-['DM_Sans','Helvetica_Neue',sans-serif] selection:bg-blue-100">
            ...
            <header className="sticky  top-2 sm:top-16 z-20 border-b border-white/70 bg-slate-50/90 px-2 pt-4 pb-3 shadow-sm shadow-blue-100/60 backdrop-blur-3xl min-[375px]:px-1 sm:top-20 sm:px-5">
 ...
 ring-1 ring-blue-100">
                ...
                {isPending ? (
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={() => setAddScheduleModalOpen(true)}
                            className="mt-8 rounded-[22px] bg-gradient-to-r from-[#0B1053] to-[#1e267e] px-7 py-3.5 text-[13px] font-black tracking-wide text-white shadow-xl shadow-[#0B1053]/30"
                        >
                            + Schedule a Session
                        </motion.button>
                    </motion.div>
            ...
            <div className="pointer-events-none fixed bottom-6 right-3 z-40 min-[375px]:bottom-8 min-[375px]:right-5">
                <motion.button
                    ...
                    onClick={() => setAddScheduleModalOpen(true)}
                    className="pointer-events-auto flex h-[52px] items-center gap-2 rounded-[22px] border border-white/25 bg-gradient-to-br from-[#0B1053] to-[#1e267e] pl-3 pr-5 text-[13px] font-black tracking-wide text-white shadow-2xl shadow-[#0B1053]/45 backdrop-blur-xl min-[375px]:h-[56px] min-[375px]:gap-2.5 min-[375px]:rounded-[24px]"
                >
