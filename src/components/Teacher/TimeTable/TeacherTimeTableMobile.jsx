...
const TeacherTimeTableMobile = ({ data, isPending, refetch, isRefetching }) => {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen pt-10 pb-10 bg-gradient-to-br from-[#f8f7ff] via-[#f0f4ff] to-[#faf5ff] font-['DM_Sans','Helvetica_Neue',sans-serif] selection:bg-indigo-100">
            {/* ══════════════════════════════
                HEADER
            ══════════════════════════════ */}
            <header className="sticky top-16 z-20 px-2 sm:px-5 pt-0 sm:pt-4 pb-4 bg-[#f8f7ff]/90 backdrop-blur-3xl border-b border-violet-500/10">
                {/* Top Row */}
                <div className="flex items-center justify-between mb-5">
                    <div className="flex flex-col">
                        <h1 className=" tex-[18px] sm:text-[22px] font-black text-slate-900 tracking-tight leading-none">
                            My Time Table
                        </h1>
                        <p className="text-[8px] sm:text-[10px] font-bold text-slate-500 mt-1.5 uppercase tracking-[0.1em]">
            ...
            {addModalOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-2 sm:p-4 bg-[#0f0a28]/45 backdrop-blur-xl">
                    <motion.div
