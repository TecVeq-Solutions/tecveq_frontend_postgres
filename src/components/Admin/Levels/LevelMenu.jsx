            ...
            <div className="relative p-8 flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-3 w-full">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3.5 rounded-2xl bg-red-500 text-white font-semibold shadow-lg shadow-red-500/25 hover:bg-red-600 transition-all active:scale-95"
                >
                  Delete Now
                </button>
              </div>
