...
const QuoteCard = ({ quote, deleteQuote, editQuote, refetch }) => {
    ...
    return (
        <div className='group relative bg-white rounded-2xl border border-gray-100 p-5 shadow-sm hover:shadow-md transition-all duration-300 ease-in-out  mb-0 sm:mb-2'>
