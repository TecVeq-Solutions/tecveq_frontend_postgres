...
const AdminTimeTableMobile = ({ data, isPending, refetch }) => {
    ...
    return (
        <div className="relative flex min-h-screen w-full min-w-[320px] flex-col overflow-x-hidden bg-gradient-to-br from-[#f6f2ff] via-[#eef4ff] to-[#fff3fb] pb-10 font-['DM_Sans','Helvetica_Neue',sans-serif] selection:bg-violet-100">
            ...
            {/* ══════════════════════════════ HEADER ══════════════════════════════ */}
            <header className="sticky top-2 sm:top-16 z-20 border-b border-white/70 bg-[#ede9fe]/90 px-2 sm:px-2 pt-4 pb-3 shadow-sm shadow-violet-100/60 backdrop-blur-3xl min-[375px]:px-1 sm:top-20 sm:px-5">
                <div className="relative overflow-hidden rounded-[28px] border border-white/80  bg-gradient-to-r from-violet-500 via-purple-600 to-indigo-700 p-1 sm:p-2 shadow-2xl shadow-violet-200/35 ring-1 ring-violet-100/50 backdrop-blur-2xl min-[375px]:rounded-[34px] min-[375px]:p-3">
                        ...
                        <div className="mt-3 grid grid-cols-3 gap-1.5 min-[375px]:mt-4 min-[375px]:gap-2">
                            <motion.button
                                ...
                                className={`flex h-10 items-center justify-center gap-1 rounded-2xl border px-1.5 text-[9px] font-black uppercase tracking-[0.08em] shadow-sm transition-all duration-200 min-[375px]:h-11 min-[375px]:gap-1.5 min-[375px]:px-2 min-[375px]:text-[10px] ${isSearchOpen
                                    ? 'border-violet-300 bg-violet-100 text-violet-700 shadow-violet-100'
                                    : 'border-white/80 bg-white/80 text-slate-500 shadow-violet-50 hover:text-violet-700'
                                    }`}
                            >
                                <IoSearch size={16} />
                                Search
                    ...
                    <AnimatePresence>
                        {(isSearchOpen || teacherID) && (
                            ...
                            >
                                <div className="relative mb-3 rounded-[22px] border border-violet-100 bg-white/85 p-1.5 shadow-sm shadow-violet-100/70 min-[375px]:mb-4 min-[375px]:rounded-[24px]">
                                    <div className="pointer-events-none absolute inset-y-0 left-5 z-10 flex items-center text-violet-500">
                                        <IoPersonOutline size={17} />
                                    </div>
                                    <select
                                        value={teacherID || ''}
                                        onChange={(e) => handleTeacherChange(e.target.value)}
                                        className="w-full appearance-none rounded-[20px] border border-transparent bg-white/90 py-3 pl-11 pr-10 text-[13px] font-black text-slate-800 outline-none transition-all duration-200 focus:border-violet-200 focus:ring-4 focus:ring-violet-100 min-[375px]:py-3.5 min-[375px]:pl-12 min-[375px]:pr-11 min-[375px]:text-sm"
                                    >
