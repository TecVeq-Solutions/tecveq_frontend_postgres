            ...
            <div className="bg-gradient-to-r from-[#6A00FF] to-[#4A00E0] px-3 sm:px-6 py-5">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white tracking-tight">Attendance Monitor</h2>
                            <p className="text-indigo-100 text-sm opacity-80">Track your academic consistency and progress</p>
                        </div>
                    </div>
                    <button
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                <select
                                    ...
                                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#EA580C] focus:border-transparent transition-all duration-200 outline-none appearance-none group-hover:bg-white group-hover:border-[#EA580C]/30 text-sm font-medium text-gray-800"
                                >
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                                <div>
                                    ...
                                    <p className="text-gray-500 text-sm mt-1">
                                        Showing data for {getDisplayName('subject', filters.subjectId)}
                                    </p>
                                </div>
                                <button
                                    onClick={handlePrint}
