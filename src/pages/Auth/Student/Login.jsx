...
const Login = () => {
    ...
    return (
        <>
            <style>{`
                ...
                @keyframes dotPulseBlue   { 0%,100%{box-shadow:0 0 0 0 rgba(37,99,235,.6)} 50%{box-shadow:0 0 0 8px rgba(37,99,235,0)} }
            ...
            <div className="flex w-full h-screen min-h-[600px] font-['Syne',sans-serif] overflow-hidden max-[900px]:flex-col max-[900px]:h-auto max-[900px]:min-h-screen max-[900px]:overflow-y-auto">
                ...
                <div className="flex-1 min-w-0 relative flex items-center justify-center bg-[#080710] overflow-hidden p-[32px_40px] cursor-crosshair max-[900px]:w-full max-[900px]:p-[32px_24px_48px] max-[640px]:p-[24px_16px_40px] max-[420px]:p-[20px_12px_36px] max-[360px]:p-[16px_10px_32px]" ref={rightPanelRef} onClick={handleRightClick}>
                    <div className="absolute pointer-events-none w-[520px] h-[520px] -top-[180px] -right-[160px] rounded-full bg-[radial-gradient(circle_at_40%_40%,rgba(37,99,235,.20)_0%,rgba(30,64,175,.11)_35%,transparent_65%)] filter blur-[30px] animate-[meshMove1_20s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[420px] h-[420px] -bottom-[140px] -left-[100px] rounded-full bg-[radial-gradient(circle_at_60%_60%,rgba(6,182,212,.18)_0%,rgba(8,145,178,.09)_40%,transparent_65%)] filter blur-[25px] animate-[meshMove2_25s_ease-in-out_infinite] max-[360px]:hidden" />
                    ...
                    <div className="absolute pointer-events-none w-[90px] h-[90px] rounded-full top-[12%] left-[8%] bg-[radial-gradient(circle,rgba(37,99,235,.28)_0%,rgba(37,99,235,.06)_60%,transparent_80%)] filter blur-[4px] animate-[orbFloat_9s_ease-in-out_infinite] max-[900px]:hidden" />
                    <div className="absolute pointer-events-none w-[60px] h-[60px] rounded-full bottom-[16%] right-[9%] bg-[radial-gradient(circle,rgba(6,182,212,.30)_0%,rgba(8,145,178,.08)_60%,transparent_80%)] filter blur-[3px] animate-[orbFloat2_12s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[45px] h-[45px] rounded-full top-[68%] left-[5%] bg-[radial-gradient(circle,rgba(37,99,235,.22)_0%,transparent_70%)] filter blur-[2px] animate-[orbFloat_7s_2s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[35px] h-[35px] rounded-full top-1/5 right-[6%] bg-[radial-gradient(circle,rgba(34,197,94,.18)_0%,transparent_70%)] filter blur-[2px] animate-[orbFloat2_8s_1s_ease-in-out_infinite] max-[900px]:hidden" />
                    ...
                    <div className="absolute w-14 h-14 pointer-events-none animate-[cornerPulse_3s_ease-in-out_infinite] top-5 right-5 border-t-2 border-r-2 border-[rgba(6,182,212,0.38)] rounded-[0_3px_0_0] delay-1000 max-[420px]:w-10 max-[420px]:h-10 max-[420px]:top-3 max-[420px]:right-3 max-[360px]:w-8 max-[360px]:h-8 max-[360px]:top-2.5 max-[360px]:right-2.5" />
                    <div className="absolute w-14 h-14 pointer-events-none animate-[cornerPulse_3s_ease-in-out_infinite] bottom-5 left-5 border-b-2 border-l-2 border-[rgba(6,182,212,0.38)] rounded-[0_0_0_3px] delay-500 max-[420px]:w-10 max-[420px]:h-10 max-[420px]:bottom-3 max-[420px]:left-3 max-[360px]:w-8 max-[360px]:h-8 max-[360px]:bottom-2.5 max-[360px]:left-2.5" />
                    <div className="absolute w-14 h-14 pointer-events-none animate-[cornerPulse_3s_ease-in-out_infinite] bottom-5 right-5 border-b-2 border-r-2 border-[rgba(37,99,235,.55)] rounded-[0_0_3px_0] delay-1500 max-[420px]:w-10 max-[420px]:h-10 max-[420px]:bottom-3 max-[420px]:right-3 max-[360px]:w-8 max-[360px]:h-8 max-[360px]:bottom-2.5 max-[360px]:right-2.5" />

                    {ripples.map(r => (
                        <div key={r.id} className="absolute w-20 h-20 rounded-full bg-[rgba(37,99,235,.18)] transform scale-0 pointer-events-none animate-[rippleOut_2s_ease-out_forwards] -ml-10 -mt-10" style={{ left: `${r.x}%`, top: `${r.y}%` }} />
                    ))}

                    {/* ── CARD ── */}
                    <div className="relative z-10 bg-[rgba(10,8,22,.80)] backdrop-blur-[24px] rounded-3xl p-[44px_40px_40px] w-full max-w-[420px] border border-[rgba(37,99,235,.25)] shadow-[0_0_0_1px_rgba(255,255,255,.04),0_8px_40px_rgba(0,0,0,.55),0_0_80px_rgba(37,99,235,.07),inset_0_1px_0_rgba(255,255,255,.05)] animate-[cardReveal_.75s_cubic-bezier(.22,1,.36,1)_forwards] before:content-[''] before:absolute before:top-0 before:left-10 before:right-10 before:h-[2px] before:bg-[linear-gradient(90deg,transparent,#3b82f6,#06b6d4,#3b82f6,transparent)] before:bg-[length:200%_100%] before:rounded-[0_0_2px_2px] before:animate-[shimmerViolet_4s_linear_infinite] after:content-[''] after:absolute after:bottom-[-1px] after:left-[20%] after:right-[20%] after:h-[1px] after:bg-[linear-gradient(90deg,transparent,rgba(37,99,235,.45),transparent)] after:rounded-full max-[640px]:p-[32px_24px_28px] max-[640px]:rounded-[20px] max-[420px]:p-[28px_18px_24px] max-[420px]:rounded-[18px] max-[360px]:p-[24px_14px_20px] max-[360px]:rounded-[16px]">
                        <div className="inline-flex items-center gap-1.5 bg-[rgba(37,99,235,.12)] border border-[rgba(37,99,235,.35)] rounded-[100px] p-[5px_12px] mb-5 animate-[floatBadge_4s_ease-in-out_infinite] max-[360px]:p-[4px_10px]">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#3b82f6] animate-[dotPulseBlue_2s_ease-in-out_infinite]" />
                            <span className="text-[11px] text-[#60a5fa] tracking-[.12em] font-semibold max-[360px]:text-[10px]">Secure Login</span>
                        </div>
    ...
    ${activeField === 'password' ? 'text-[#60a5fa]' : 'text-black'}`}>
                                    ...
                                    <input
                                        ...
                                        onBlur={() => setActiveField(null)}
                                    />
                                    <button type="button" className="absolute right-3.5 top-1/2 -translate-y-1/2 bg-none border-none cursor-pointer text-[rgba(255,255,255,.26)] flex items-center transition-colors duration-200 hover:text-[#60a5fa] max-[360px]:right-[11px]" onClick={() => setShowPassword(!showPassword)}>
                                        {showPassword ? (
                            ...
                            <div className="flex justify-between items-center mb-6 max-[420px]:flex-wrap max-[420px]:gap-2 max-[360px]:mb-4">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" className="w-[15px] h-[15px] cursor-pointer accent-[#3b82f6]" />
                            ...
                            <p className="text-center text-[13px] text-[rgba(235,245,255,0.4)] max-[360px]:text-xs">
                                ...
                                <span className="text-[#60a5fa] font-semibold cursor-pointer transition-colors duration-200 hover:text-[#06b6d4] hover:shadow-[0_0_12px_rgba(37,99,235,0.5)]" onClick={handleGoToSignUp}>Sign up now</span>
                            </p>
                        </form>
                    </div>
                </div>
