    ...
    return (
        <>
            <style>{`
                ...
                @keyframes cyanPulse   { 0%,100%{opacity:.6;transform:scale(1)} 50%{opacity:1;transform:scale(1.1)} }
                @keyframes dotPulseCyan   { 0%,100%{box-shadow:0 0 0 0 rgba(0,212,255,.6)} 50%{box-shadow:0 0 0 8px rgba(0,212,255,0)} }
                @keyframes dotPulseViolet { 0%,100%{box-shadow:0 0 0 0 rgba(168,85,247,.6)} 50%{box-shadow:0 0 0 8px rgba(168,85,247,0)} }
                ...
                @keyframes rotateRingR { from{transform:rotate(360deg)} to{transform:rotate(0deg)} }
                ...
                @keyframes gridGlow    { 0%,100%{opacity:.4} 50%{opacity:.75} }
                @keyframes lineTrail   { 0%{transform:translateY(-100%);opacity:0} 10%{opacity:1} 90%{opacity:1} 100%{transform:translateY(200%);opacity:0} }
                @keyframes cornerPulse { 0%,100%{opacity:.4} 50%{opacity:1} }
                @keyframes rippleOut   { 0%{transform:scale(0);opacity:.25} 100%{transform:scale(6);opacity:0} }
                @keyframes btnShine    { 0%{left:-100%} 100%{left:200%} }
            `}</style>

            <div className="flex w-full h-screen min-h-[600px] font-['Syne',sans-serif] overflow-hidden max-[900px]:flex-col max-[900px]:h-auto max-[900px]:min-h-screen max-[900px]:overflow-y-auto">

                {/* ══════════ LEFT PANEL ══════════ */}
                <div className="w-[54%] shrink-0 relative flex flex-col justify-center px-16 bg-[#020c14] overflow-hidden max-[900px]:w-full max-[900px]:px-9 max-[900px]:py-10 max-[900px]:min-h-auto max-[640px]:px-5 max-[420px]:px-4 max-[360px]:px-3" ref={leftPanelRef}>
                    <div style={{
                    ...
                    <div className="absolute -bottom-[120px] -right-[120px] w-[500px] h-[500px] pointer-events-none max-[900px]:hidden">
                        <div className="absolute inset-0 rounded-full border border-[rgba(0,212,255,0.12)] animate-[rotateRing_30s_linear_infinite]">
                            <div className="absolute w-2 h-2 rounded-full bg-[#00d4ff] -top-1 left-1/2 -translate-x-1/2 animate-[dotPulseCyan_2.5s_ease-in-out_infinite]" />
                        </div>
                        <div className="absolute inset-[50px] border border-[rgba(0,212,255,0.07)] rounded-full animate-[rotateRingR_22s_linear_infinite]" />
                        <div className="absolute inset-[100px] border border-dashed border-[rgba(0,212,255,0.05)] rounded-full animate-[rotateRing_18s_linear_infinite]" />
                    </div>
                    ...
                    {[
                        ...
                        <div key={i} style={{
                            ...
                            animationDelay: p.d, pointerEvents: 'none', zIndex: 1,
                        }} />
                    ))}
                    ...
                    <div className="relative z-[2] max-w-[480px] animate-[leftReveal_0.8s_ease_forwards]">
                        <div className="mb-9 max-[420px]:mb-6 max-[360px]:mb-[18px]">
                            ...
                            <div className="flex items-center gap-3 mt-3.5">
                                ...
                                <span className="text-[10px] tracking-[0.3em] uppercase text-[rgba(0,212,255,.7)] font-semibold">Learning Platform</span>
                            </div>
                        </div>
                        <div className="mb-8 max-[420px]:mb-5">
                        ...
                        <div className="grid grid-cols-3 gap-3 animate-[countUp_0.9s_0.5s_ease_forwards] opacity-0 max-[640px]:gap-2 max-[420px]:gap-1.5 max-[360px]:gap-[5px]">
                ...
                <div className="flex-1 min-w-0 relative flex items-center justify-center bg-[#080710] overflow-hidden p-[32px_40px] cursor-crosshair max-[900px]:w-full max-[900px]:p-[32px_24px_48px] max-[640px]:p-[24px_16px_40px] max-[420px]:p-[20px_12px_36px] max-[360px]:p-[16px_10px_32px]" ref={rightPanelRef} onClick={handleRightClick}>
                    <div className="absolute pointer-events-none w-[520px] h-[520px] -top-[180px] -right-[160px] rounded-full bg-[radial-gradient(circle_at_40%_40%,rgba(168,85,247,.20)_0%,rgba(120,50,200,.11)_35%,transparent_65%)] filter blur-[30px] animate-[meshMove1_20s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[420px] h-[420px] -bottom-[140px] -left-[100px] rounded-full bg-[radial-gradient(circle_at_60%_60%,rgba(232,121,249,.18)_0%,rgba(180,60,200,.09)_40%,transparent_65%)] filter blur-[25px] animate-[meshMove2_25s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[360px] h-[360px] top-[40%] left-[35%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(100,40,160,.13)_0%,transparent_65%)] filter blur-[20px] animate-[meshMove3_16s_ease-in-out_infinite] max-[360px]:hidden" />
                    ...
                    <div className="absolute top-0 bottom-0 w-[1px] left-1/4 bg-[linear-gradient(180deg,transparent,rgba(168,85,247,0.20),transparent)] animate-[lineTrail_7s_linear_infinite] pointer-events-none" />
                    ...
                    <div className="absolute pointer-events-none w-[90px] h-[90px] rounded-full top-[12%] left-[8%] bg-[radial-gradient(circle,rgba(168,85,247,.28)_0%,rgba(168,85,247,.06)_60%,transparent_80%)] filter blur-[4px] animate-[orbFloat_9s_ease-in-out_infinite] max-[900px]:hidden" />
                    <div className="absolute pointer-events-none w-[60px] h-[60px] rounded-full bottom-[16%] right-[9%] bg-[radial-gradient(circle,rgba(232,121,249,.30)_0%,rgba(200,80,220,.08)_60%,transparent_80%)] filter blur-[3px] animate-[orbFloat2_12s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[45px] h-[45px] rounded-full top-[68%] left-[5%] bg-[radial-gradient(circle,rgba(168,85,247,.22)_0%,transparent_70%)] filter blur-[2px] animate-[orbFloat_7s_2s_ease-in-out_infinite] max-[360px]:hidden" />
                    <div className="absolute pointer-events-none w-[35px] h-[35px] rounded-full top-1/5 right-[6%] bg-[radial-gradient(circle,rgba(120,220,180,.18)_0%,transparent_70%)] filter blur-[2px] animate-[orbFloat2_8s_1s_ease-in-out_infinite] max-[900px]:hidden" />
                    ...
                    <div className="absolute w-14 h-14 pointer-events-none animate-[cornerPulse_3s_ease-in-out_infinite] bottom-5 right-5 border-b-2 border-r-2 border-[rgba(168,85,247,.55)] rounded-[0_0_3px_0] delay-1500 max-[420px]:w-10 max-[420px]:h-10 max-[420px]:bottom-3 max-[420px]:right-3 max-[360px]:w-8 max-[360px]:h-8 max-[360px]:bottom-2.5 max-[360px]:right-2.5" />

                    {ripples.map(r => (
                        <div key={r.id} className="absolute w-20 h-20 rounded-full bg-[rgba(168,85,247,.18)] transform scale-0 pointer-events-none animate-[rippleOut_2s_ease-out_forwards] -ml-10 -mt-10" style={{ left: `${r.x}%`, top: `${r.y}%` }} />
                    ))}

                    {/* ── CARD ── */}
                    <div className="relative z-10 bg-[rgba(10,8,22,.80)] backdrop-blur-[24px] rounded-3xl p-[44px_40px_40px] w-full max-w-[420px] border border-[rgba(168,85,247,.25)] shadow-[0_0_0_1px_rgba(255,255,255,.04),0_8px_40px_rgba(0,0,0,.55),0_0_80px_rgba(168,85,247,.07),inset_0_1px_0_rgba(255,255,255,.05)] animate-[cardReveal_.75s_cubic-bezier(.22,1,.36,1)_forwards] before:content-[''] before:absolute before:top-0 before:left-10 before:right-10 before:h-[2px] before:bg-[linear-gradient(90deg,transparent,#a855f7,#e879f9,#a855f7,transparent)] before:bg-[length:200%_100%] before:rounded-[0_0_2px_2px] before:animate-[shimmerViolet_4s_linear_infinite] after:content-[''] after:absolute after:bottom-[-1px] after:left-[20%] after:right-[20%] after:h-[1px] after:bg-[linear-gradient(90deg,transparent,rgba(168,85,247,.45),transparent)] after:rounded-full max-[640px]:p-[32px_24px_28px] max-[640px]:rounded-[20px] max-[420px]:p-[28px_18px_24px] max-[420px]:rounded-[18px] max-[360px]:p-[24px_14px_20px] max-[360px]:rounded-[16px]">
                        <div className="inline-flex items-center gap-1.5 bg-[rgba(168,85,247,.12)] border border-[rgba(168,85,247,.35)] rounded-[100px] p-[5px_12px] mb-5 animate-[floatBadge_4s_ease-in-out_infinite] max-[360px]:p-[4px_10px]">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#a855f7] animate-[dotPulseViolet_2s_ease-in-out_infinite]" />
                            <span className="text-[11px] text-[#c084fc] tracking-[.12em] font-semibold max-[360px]:text-[10px]">Secure Login</span>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4 max-[360px]:mb-3">
                                <label className={`block text-[10.5px] font-bold tracking-[.14em] uppercase mb-2 transition-colors duration-[0.25s] max-[360px]:text-[9.5px] ${activeField === 'role' ? 'text-[#c084fc]' : 'text-[rgba(240,235,255,.35)]'}`}>Login As</label>
                                <div className="relative">
                                    <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 flex items-center transition-colors duration-[0.25s] pointer-events-none max-[360px]:left-[11px] ${activeField === 'role' ? 'text-[#c084fc]' : 'text-[rgba(255,255,255,.22)]'}`}>
                                        <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                        </svg>
                                    </div>
                                    <select
                                        className="w-full p-[13px_16px_13px_42px] bg-[rgba(255,255,255,0.05)] border border-[rgba(168,85,247,0.18)] rounded-xl text-sm font-['Syne',sans-serif] text-[#f3eeff] outline-none transition-all duration-300 cubic-bezier(0.4,0,0.2,1) appearance-none focus:border-[rgba(168,85,247,0.75)] focus:bg-[rgba(168,85,247,0.06)] focus:shadow-[0_0_0_4px_rgba(168,85,247,0.14)] max-[420px]:text-[13px] max-[420px]:p-[12px_14px_12px_40px] max-[360px]:text-[12.5px] max-[360px]:p-[11px_12px_11px_38px] max-[360px]:rounded-[10px]"
                                        onFocus={() => setActiveField('role')}
                                        onBlur={() => setActiveField(null)}
                                    >
                                        <option value="student" className="bg-[#12102a] text-[#f3eeff]">Student</option>
                                        <option value="parent" className="bg-[#12102a] text-[#f3eeff]">Parent</option>
                                    </select>
                                    <div className="absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-[rgba(255,255,255,.25)] max-[360px]:right-[11px]">
                            ...
                            {/* Email */}
                            <div className="mb-4 max-[360px]:mb-3">
                                <label className={`block text-[10.5px] font-bold tracking-[.14em] uppercase mb-2 transition-colors duration-[0.25s] max-[360px]:text-[9.5px] ${activeField === 'email' ? 'text-[#c084fc]' : 'text-[rgba(240,235,255,.35)]'}`}>Email Address</label>
                                <div className="relative">
                                    <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 flex items-center transition-colors duration-[0.25s] pointer-events-none max-[360px]:left-[11px] ${activeField === 'email' ? 'text-[#c084fc]' : 'text-[rgba(255,255,255,.22)]'}`}>
                                        <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            ...
                            {/* Password */}
                            <div className="mb-4 max-[360px]:mb-3">
                                <label className={`block text-[10.5px] font-bold tracking-[.14em] uppercase mb-2 transition-colors duration-[0.25s] max-[360px]:text-[9.5px] ${activeField === 'password' ? 'text-[#c084fc]' : 'text-[rgba(240,235,255,.35)]'}`}>Password</label>
                                <div className="relative">
                                    <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 flex items-center transition-colors duration-[0.25s] pointer-events-none max-[360px]:left-[11px] ${activeField === 'password' ? 'text-[#c084fc]' : 'text-[rgba(255,255,255,0.22)]'}`}>
                                        <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    ...
                                    <input
                                        ...
                                        onBlur={() => setActiveField(null)}
                                    />
                                    <button type="button" className="absolute right-3.5 top-1/2 -translate-y-1/2 bg-none border-none cursor-pointer text-[rgba(255,255,255,.26)] flex items-center transition-colors duration-200 hover:text-[#c084fc] max-[360px]:right-[11px]" onClick={() => setShowPassword(!showPassword)}>
                                        {showPassword ? (
                            ...
                            {/* Remember & Forgot */}
                            <div className="flex justify-between items-center mb-6 max-[420px]:flex-wrap max-[420px]:gap-2 max-[360px]:mb-4">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" className="w-[15px] h-[15px] cursor-pointer accent-[#a855f7]" />
                                    <span className="text-[12.5px] text-[rgba(240,235,255,.36)] select-none max-[360px]:text-[11px]">Remember me</span>
                                </label>
                                <button type="button" className="bg-none border-none font-['Syne',sans-serif] text-[12.5px] text-[rgba(240,235,255,.3)] cursor-pointer transition-colors duration-200 hover:text-[#c084fc] max-[360px]:text-[11px]">Forgot Password</button>
                            </div>
                            ...
                            <div className="mb-5">
                                {loading ? (
                                    ...
                                    <button type="submit" className="w-full p-[15px] bg-[linear-gradient(135deg,#7c3aed_0%,#a855f7_40%,#e879f9_80%,#c026d3_100%)] bg-[length:200%_100%] border-none rounded-xl text-white text-sm font-bold tracking-[.08em] cursor-pointer font-['Syne',sans-serif] relative overflow-hidden transition-all duration-300 cubic-bezier(.4,0,.2,1) shadow-[0_4px_20px_rgba(168,85,247,.38)] hover:bg-right hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(168,85,247,.55)] active:translate-y-0 active:shadow-[0_4px_16px_rgba(168,85,247,.38)] before:content-[''] before:absolute before:top-0 before:-left-full before:w-3/5 before:h-full before:bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.28),transparent)] before:skew-x-[-20deg] before:animate-[btnShine_4s_ease-in-out_infinite_1s]">Sign In &nbsp;→</button>
                                )}
                            </div>

                            {/* Divider */}
                            <div className="flex items-center gap-3.5 mt-[22px] mb-[18px] max-[360px]:mt-4 max-[360px]:mb-3.5">
                                <div className="flex-1 h-[1px] bg-[rgba(168,85,247,.14)]" />
                                <span className="text-[10px] text-[rgba(168,85,247,.45)] tracking-[.2em] font-semibold">New Here?</span>
                                <div className="flex-1 h-[1px] bg-[rgba(168,85,247,.14)]" />
                            </div>

                            {/* Sign up */}
                            <p className="text-center text-[13px] text-[rgba(240,235,255,.32)] max-[360px]:text-xs">
                                Don't have an account?{' '}
                                <span className="text-[#c084fc] font-semibold cursor-pointer transition-colors duration-200 hover:text-[#e879f9] hover:shadow-[0_0_12px_rgba(168,85,247,0.5)]" onClick={handleGoToSignUp}>Sign up now</span>
                            </p>
                        </form>
                    </div>
                </div>
