...
const Quizzes = () => {
    ...
    // Pagination logic
    const totalItems = studentQuiz.length;
    ...
    const paginatedQuizzes = useMemo(() => {
        ...
        return studentQuiz.slice(startIndex, endIndex);
    }, [studentQuiz, currentPage, rowsPerPage]);
                ...
                <div className="w-full lg:px-20 sm:px-10 px-3 flex-grow ml-0 lg:ml-72">
                    <div className="pt-1">
                        ...
                        >
                            {/* Header Banner */}
                            <div
                                className="mt-6 mb-6 rounded-2xl px-3 sm:px-6 py-5 flex items-center gap-4"
                                style={{
                                    background:
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-purple-200 text-sm mt-0.5">
                                        {studentQuiz.length} quiz
                                        {studentQuiz.length !== 1 ? "zes" : ""} assigned
                                    </p>
                                </div>
                            </div>
                                ...
                                {studentQuiz.length > 0 ? (
                                        ...
                                        <div className="mt-4 sm:mt-6 mb-4 flex flex-row items-center justify-between sm:gap-4 gap-4 rounded-[15px] sm:rounded-3xl border border-[#E8E3FF] bg-white/80 backdrop-blur-md px-1 sm:px-6 py-4 shadow-[0_8px_30px_rgba(106,0,255,0.08)]">
                                            ...
                                            <div className="hidden sm:flex flex-col items-center text-center">
                                                <p className="text-sm font-semibold text-[#0B1053]">
                                                    ...
                                                    <span className="text-[#6A00FF]">{totalItems}</span> Quizzes
                                                </p>
                                    ...
                                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                                        ...
                                        <p className="text-gray-400 text-sm">
                                            Your teacher hasn't posted any quizzes.
                                        </p>
                                    </div>
                                )}
                            </div>
