...
const StudentLeaves = () => {
    ...
    }, [leaves, currentPage, rowsPerPage]);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/40 to-cyan-50/40 font-poppins">
            <div className="lg:ml-72 xl:ml-80 flex flex-col">
                <Navbar heading="My Leaves" />

                <div className="p-3 sm:p-4 md:p-8 space-y-8">
                    {/* Header Banner */}
                    <div className="relative overflow-hidden rounded-[1rem] sm:rounded-[2rem] bg-gradient-to-r from-[#080f4f] via-indigo-800 to-cyan-700 p-4 sm:p-6 md:p-8 shadow-2xl shadow-indigo-900/20">
                        ...
                        <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                            ...
                            {!showForm && !editingLeave && (
                                <button
                                    ...
                                    className="group relative overflow-hidden flex items-center justify-center gap-2 bg-white text-[#080f4f] px-6 py-4 rounded-[1rem] sm:rounded-2xl font-black text-sm shadow-2xl shadow-black/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-white/20 active:scale-95"
                                >
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {leaves.length > 0 ? (
                            <div className="overflow-hidden rounded-[2rem] bg-white/90 backdrop-blur-xl shadow-2xl shadow-slate-200/60 border border-white">
                                        ...
                                        <tbody className="divide-y divide-slate-100">
                                            {paginatedLeaves.map((leave, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 sm:px-6 py-5">
                                                        <div className="inline-flex items-center gap-2 rounded-2xl bg-slate-50 px-3 py-2 text-sm font-bold text-slate-600 ring-1 ring-slate-100">
                                                    ...
                                                    <td className="px-4 sm:px-6 py-5">
                                                        <span className="inline-flex items-center justify-center min-w-12 rounded-2xl bg-cyan-50 px-3 py-2 text-sm font-black text-cyan-700 ring-1 ring-cyan-100">
                                                            {leave.totalDays}
                                                        </span>
                                                    </td>
                                ...
                                {/* Pagination Footer */}
                                {leaves.length > 0 && (
                                    <div className="mt-4 sm:mt-6 mb-4 flex lg:flex-row items-center justify-between sm:gap-4 gap-2 rounded-[15px] sm:rounded-3xl border border-[#E8E3FF] bg-white/80 backdrop-blur-md px-1 sm:px-6 py-4 shadow-[0_8px_30px_rgba(106,0,255,0.08)] mx-4">
                                        <div className="flex flex-row items-center gap-1 sm:gap-3 w-full lg:w-auto justify-center lg:justify-start">
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="pointer-events-none absolute inset-y-0 right-3 flex items-center">
                                                    <svg className="w-4 h-4 text-[#6A00FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="hidden sm:flex flex-col items-center text-center">
                                            <p className="text-sm font-semibold text-[#0B1053]">
                                                Showing <span className="text-[#6A00FF]">{startItem}</span> to <span className="text-[#6A00FF]">{endItem}</span> of <span className="text-[#6A00FF]">{totalItems}</span> Requests
                                            </p>
                                                ...
                                                {Array.from({ length: totalPages }, (_, i) => i + 1)
                                                    ...
                                                    .map((page, index, arr) => (
                                                        <React.Fragment key={page}>
                                                            {index > 0 && page - arr[index - 1] > 1 && <span className="px-1 text-gray-400 text-sm">...</span>}
                                                            <button
                                                                onClick={() => goToPage(page)}
                                                                className={`w-8 h-8 sm:w-10 sm:h-10 rounded-2xl text-sm font-bold transition-all duration-200 active:scale-95 ${currentPage === page ? "bg-gradient-to-br from-[#7B1FFF] to-[#5500CC] text-white shadow-[0_5px_16px_rgba(106,0,255,0.35)]" : "bg-[#F6F3FF] text-[#6A00FF] hover:bg-[#ECE6FF]"}`}
                                                            >
                                                                {page}
                                                            </button>
                                                        </React.Fragment>
                            ...
                            <div className="relative overflow-hidden rounded-[2rem] bg-white/90 backdrop-blur-xl p-12 md:p-16 text-center shadow-2xl shadow-slate-200/60 border border-white">
                                ...
                                <div className="relative h-24 w-24 bg-gradient-to-br from-indigo-50 to-cyan-50 rounded-[2rem] flex items-center justify-center mx-auto mb-6 text-indigo-400 shadow-inner">
                                    <IoTimeOutline size={44} />
                                </div>
                                <h3 className="text-2xl font-black text-slate-900 mb-2">No leave requests found</h3>
                                <p className="text-slate-400 max-w-sm mx-auto font-semibold mb-7">You have not submitted any leave request yet. Create your first request whenever you need time off.</p>
                                {!showForm && (
                                    <button onClick={() => setShowForm(true)} className="inline-flex items-center justify-center gap-2 bg-[#080f4f] text-white px-6 py-3.5 rounded-2xl font-black text-sm shadow-xl shadow-indigo-900/15 hover:-translate-y-0.5 active:scale-95 transition">
