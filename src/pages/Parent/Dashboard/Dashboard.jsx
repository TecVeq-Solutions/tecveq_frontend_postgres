    ...
    >
      ...
      <div className="flex flex-1 gap-4 relative z-10">
        <div className={`flex flex-col flex-1 px-2 sm:px-5 lg:ml-80`}>
          ...
          <div className="flex flex-col md:px-10 lg:px-0 lg:flex-row flex-1 gap-5 py-2">
          ...
          <div className="flex flex-col md:px-10 lg:px-0 lg:flex-row flex-1 gap-5 pb-10 pt-2 my-2">
