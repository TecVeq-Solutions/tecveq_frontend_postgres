                ...
                <div className="w-full lg:px-20 sm:px-10 px-3 flex-grow ml-0 lg:ml-72 xl:ml-80">
                    <div className="pt-1">
                        ...
                        >
                            {/* Header Banner */}
                            <div
                                className="mt-3 sm:mt-6  mb-3 sm:mb-6 rounded-2xl px-3  sm:px-6 py-5 flex items-center gap-4"
                                style={{
                                    background:
                                            ...
                                            {paginatedQuizzes.map((quiz, index) => {
                                                ...
                                                return (
                                                    <QuizAssignmentRow
                                                        ...
                                                        id={quiz.id}
                                                        subject={
                                                            quiz?.subject?.name || quiz?.subjectID?.name
                                                        }
                                                        title={quiz?.title}
