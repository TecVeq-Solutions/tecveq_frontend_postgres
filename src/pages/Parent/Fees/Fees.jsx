                            ...
                            <table className="w-full min-w-[800px] text-left border-collapse">
                                <thead>
                                    <tr className="bg-[#0B1053] border-b border-[#0B1053]">
                                        <th className="py-5 text-xs font-bold text-white uppercase tracking-widest  px-3 sm:px-8">Fee Type</th>
                                        <th className="px-3 sm:px-6 py-5 text-xs font-bold text-white uppercase tracking-widest">Period</th>
                                        <th className="px-px-3 sm:px-6 py-5 text-xs font-bold text-white uppercase tracking-widest">Amount</th>
                                        <th className="px-3 sm:px-6 py-5 text-xs font-bold text-white uppercase tracking-widest">Due Date</th>
                                        <th className="px-3 sm:px-6 py-5 text-xs font-bold text-white uppercase tracking-widest text-center">Status</th>
                                    </tr>
                                </thead>
