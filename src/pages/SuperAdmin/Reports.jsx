...
const Reports = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f5f7fb] font-poppins pb-20">
            ...
            <main className="max-w-screen-2xl p-4 sm:p-6 md:p-8 mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                    {/* Revenue Trend Chart */}
                    <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-sm ring-1 ring-slate-100 flex flex-col">
                ...
                {/* FILTERS */}
                <div className="bg-white rounded-[2rem] p-6 mb-8 shadow-sm ring-1 ring-slate-100">
                ...
                <div className="bg-white rounded-[2rem] shadow-sm ring-1 ring-slate-100 overflow-hidden mb-10">
                    <div className="p-6 md:p-8 border-b border-slate-100 flex justify-between items-center">
                        <h3 className="text-lg font-black text-slate-900">Institute Performance Report</h3>
                        <span className="bg-indigo-50 text-indigo-700 font-bold px-3 py-1 rounded-lg text-xs">{filteredInstitutes?.length || 0} Results</span>
                    </div>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left whitespace-nowrap">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {filteredInstitutes?.length === 0 ? (
                                    <tr><td colSpan="7" className="text-center py-10 text-slate-500 font-medium">No institutes match the filters.</td></tr>
                                ) : (
                                        ...
                                        <tr key={idx} className="hover:bg-slate-50 transition">
                                            ...
                                            <td className="py-4 px-4">
                                                <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-bold ${
                                                    inst.accountStatus?.toLowerCase() === 'active' ? 'bg-emerald-50 text-emerald-700' :
                                            ...
                                            <td className="py-4 px-4">
                                                <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-bold ${
                                                    inst.paymentStatus?.toLowerCase() === 'paid' ? 'bg-emerald-50 text-emerald-700' :
