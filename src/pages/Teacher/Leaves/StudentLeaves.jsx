...
const TeacherStudentLeaves = () => {
    ...
    const fetchRequests = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${BACKEND_URL}/leave/student-requests`, config);
            setRequests(res.data);
        } catch (error) {
            toast.error('Failed to fetch student leave requests');
        } finally {
            setLoading(false);
        }
    };
                        ...
                        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-indigo-200 font-light">
                                    Review and process leave applications from students
                                </p>
                            </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative flex flex-col sm:flex-row sm:items-center gap-5 sm:justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            >
                                                {getInitials(activeRequest.student?.name)}
                                            </div>
                                ...
                                <div className="p-3  sm:p-5 ">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
                                        {[
                                            { icon: <IoPersonOutline size={15} />, label: 'Student', value: activeRequest.student?.name, color: 'text-violet-500', bg: 'bg-violet-50', ring: 'ring-violet-100' },
                                            { icon: <IoSchoolOutline size={15} />, label: 'Class', value: activeRequest.student?.level?.name || 'Classroom', color: 'text-blue-500', bg: 'bg-blue-50', ring: 'ring-blue-100' },
                                    ...
                                    >
                                        <p className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.2em] text-indigo-400 mb-1 sm:mb-3">
                                ...
                                {filteredRequests.length > 0 ? (
                                                        ...
                                                        <div className="flex items-center gap-5 px-3 sm:px-6 py-5">
                                                            ...
                                                            <div className="min-w-0 flex-1">
                                                                ...
                                                                <div className="mt-2.5 flex flex-wrap items-center gap-2.5">
                                                                    {[
                                                                        { icon: <IoSchoolOutline size={14} />, text: req.student?.level?.name || 'Classroom' },
                                    ...
                                    >
                                        ...
                                        <p className="text-slate-400 text-sm font-light max-w-xs mx-auto leading-relaxed">
                                            No student leave requests match your current filters.
                                        </p>
                                    </motion.div>
                                )}
                            </motion.div>
