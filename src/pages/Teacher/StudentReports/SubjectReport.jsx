...
const SubjectReport = () => {
  ...
  return (
    <div
      className={`flex flex-1 bg-[#F4F6FB] font-poppins min-h-screen relative min-w-0 ${isBlurred ? "blur" : ""
        }`}
    >
      <div className="flex flex-1 min-w-0">
        {/* ── FIX 1: removed duplicate sm:px-4 ── */}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  <div className="px-3 sm:px-6 pb-4 sm:pb-6 mt-0 sm:mt-14 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 sm:gap-4 min-w-0">
                      ...
                      {/* Avatar + name */}
                      <div className="flex flex-col sm:flex-row items-center sm:items-end gap-3 -mt-10 min-w-0">
