...
const Assignments = () => {
  ...
  const onGradingAssignment = () =>
    navigate(`/teacher/assignments/GradingAssignments`, {
  ...
  const totalSubmissions =
    data?.reduce((acc, a) => acc + (a.submissions?.length || 0), 0) || 0;

  const totalStudents =
    data?.reduce(
      (acc, a) => acc + (a.classroomID?.students?.length || 0),
      0
    ) || 0;
                ...
                <>
                  <div className="divide-y divide-gray-50">
                    {paginatedAssignments.map((assignment, index) => {
                      const expectedCount =
                        assignment?.classroomID?.students?.length || 0;
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 md:contents w-full gap-2 sm:gap-4 md:gap-2">
                            ...
                            <div className="md:col-span-2">
                              ...
                              >
                                {isOverdue ? "⏰" : "📅"}{" "}
                                {moment(assignment.dueDate).format("DD MMM")}
                              </span>
                            </div>
                            ...
                            <div className="flex-col md:col-span-3 flex sm:items-center sm:justify-end md:justify-center gap-1.5 md:gap-1 mt-2 md:mt-0">
                              <div>    <p className="md:hidden text-[10px] uppercase font-bold text-gray-400 mr-2">
                                Actions:
                              </p>
                              </div>
                              <div className=" flex gap-1 ">
                                ...
                                <ActionBtn
                                  onClick={() =>
                                    navigate(
                                      `/teacher/assignments/GradingAssignments`,
                                      { state: assignment }
                                    )
                                  }
